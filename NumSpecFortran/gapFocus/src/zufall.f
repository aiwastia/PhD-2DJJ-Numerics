...
c      double precision t1,t2,second
c      integer p(n)
c      integer seed
c
...
c     *   15x,24('='))
c200   format(/1x,36('-')/
c     *   1x,'***** Initialization of zufall *****'/,
c     *   1x,36('-'))
c300   format(/1x,' Initialization sequence takes ',e12.3,' seconds')
c400   format(/1x,37('-')/
c     *   1x,'***** Uniform distribution test *****'/,
c     *   1x,37('-')/)
c500   format(/1x,38('-')/
c     *   1x,'***** Gaussian distribution test *****'/,
c     *   1x,37('-')/)
c600   format(/1x,38('-')/
c     *   1x,'***** Poisson distribution test *****'/,
c     *   1x,37('-')/)
c700   format(/15x,24('=')/
c     *   15x,'===== END OF TESTS ====='/,
c     *   15x,24('=')/)

...
write(*,"(6(a,a,a))") (vartitle(i),achar(9),achar(9),i=1,6)
...
tottime=tottime+result
	...
	Aloopparam(6)=gap
	write(*,'(F8.4,a,F8.4,a,F8.3,a,F8.4,a,F8.6,a,F15.12,a)') (Aloopparam(g2),achar(9),g2=1,6) !fill in each column of data to plot
    !flush(30)
